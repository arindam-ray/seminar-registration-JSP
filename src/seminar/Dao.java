...
public class Dao {
  ...
  public static Connection getConnection() {
    ...
    try {
      ...
      /**
       * These are <code>public static final</code> variables 
       * from the Credentials.class . 
       * You can use won string variables like
       * public class Credentials {
       *     public static final String jdbcUrl = "jdbc:mysql://localhost:3306/database_name";
